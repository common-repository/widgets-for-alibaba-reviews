<?php
class TrustindexPlugin_alibaba
{
...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-12.4.1", "do-not-care-Widgets for Alibaba Reviews", "do-not-care-Alibaba");
